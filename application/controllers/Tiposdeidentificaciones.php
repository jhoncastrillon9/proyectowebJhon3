...
/* 
controlador Para los tipos de identificaciones

*/
class Tiposdeidentificaciones extends CI_Controller {
	...
	public function index()
	{
		...
		$crud->set_table('tiposdeidentificacion'); 
		$crud->set_subject('Listado de tipos de identificaciones');	
		$crud->display_as('nombre','Ingrese el tipo de identificación');
		...
		$this->load->view('tiposdeidentificaciones',$vector);
	}
