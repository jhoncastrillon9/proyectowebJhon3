...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Aplicativo</b>Siscliente</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php echo form_open("login/acceso/");?>
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Correo" autocomplete="off" required name="correo" id="correo">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Clave" autocomplete="off" required name="clave" id="clave">
