...
*/
$ruta=base_url()."assets/imagenes/usuarios/".$fotousuario;
//echo $ruta;
//exit();
?>
...
<header class="main-header">
    <!-- Logo -->
    <a href="<?php echo site_url('principal')?>" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $ruta?>" class="user-image" alt="<?php echo $usuario;?>">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo site_url('salir')?>" class="btn btn-default btn-flat">Salir</a>
                </div>
              </li>
            </ul>
          </li>
